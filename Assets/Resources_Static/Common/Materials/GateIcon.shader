	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				float r = sin(o.vertex.x + _Time.y) * 0.5 + 0.85;
				float g = cos(o.vertex.y + _Time.y) * 0.5 + 0.85;
				float b = sin(o.vertex.z + _Time.y) * 0.5 + 0.35;

				o.setColor = float4(r, g, b, 1);
